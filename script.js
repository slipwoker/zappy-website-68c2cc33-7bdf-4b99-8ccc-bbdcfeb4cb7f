      ...
      (async function() {
        try {
          ...
          const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
            ...
            body: JSON.stringify({
              websiteId: '68c2cc33-7bdf-4b99-8ccc-bbdcfeb4cb7f',
              name: name,
              email: email,
              subject: subjectField ? subjectField.value : 'Contact Form Submission',
              message: messageField ? messageField.value : 'Phone: ' + phone,
              phone: phone
            })
          });
    ...
    "translations": {
      "en": {
        "consentModal": {
          ...
          "description": "Sivan Askayo Photography uses cookies to enhance your experience, analyze site usage, and assist in our marketing efforts. You can manage your preferences anytime.",
